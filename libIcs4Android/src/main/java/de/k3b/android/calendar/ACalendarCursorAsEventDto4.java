...
public class ACalendarCursorAsEventDto4 extends ACalendarCursorAsEventDto {
    /**
     ...
     */
    public ACalendarCursorAsEventDto4(final Context ctx, final SQLiteDatabase mockDatabase) {
